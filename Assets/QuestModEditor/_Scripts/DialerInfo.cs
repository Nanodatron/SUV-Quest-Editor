...
public class DialerInfo : MonoBehaviour {
	...
	void Awake ()
	{
		...
		header = root.transform.Find("GUI/HEADER").gameObject; 
		bubble = root.transform.Find("MOBILE_pos/bubble_pos").gameObject;
		collisions = root.transform.Find("MOBILE_pos/STATUS_trm").gameObject;
		...
		character = root.transform.Find("MOBILE_pos/character_scl/character_sprite").gameObject; 
