...
public class DialerNewDef: MonoBehaviour {
	...
	void Awake ()
	{
		...
		notifEndQ = root.transform.Find("GUI/NOTIFICATIONS/quest_complete").gameObject; // pointe la notif "new_quest"
