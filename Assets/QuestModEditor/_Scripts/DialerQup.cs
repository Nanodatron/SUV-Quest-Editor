...
public class DialerQup : MonoBehaviour {
	...
	void Awake ()
	{
		...
		notifNewQ = root.transform.Find("GUI/NOTIFICATIONS/new_quest").gameObject; // pointe la notif "new_quest"
